...
const About = () => {
  return (
    <section
      ...
      className="pt-28 sm:pt-32 md:pt-36 pb-12 sm:pb-16 md:pb-20 px-4 bg-background min-h-screen flex flex-col justify-center"
    >
      <div className="max-w-4xl mx-auto">
        {/* Titre principal */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-6 sm:mb-8 md:mb-12 text-center">
          À propos
        </h2>
        ...
        <div className="space-y-6 md:space-y-12">
          ...
          <p className="text-sm sm:text-base md:text-lg text-card-foreground leading-relaxed text-center">
            ...
            <strong className="text-primary">OpenClassrooms</strong>
            {" "}pour devenir développeuse web. Cette expérience m'a permis de
            combiner ma créativité et ma logique technique pour concevoir des
            sites performants et accessibles.
          </p>
          ...
          <div className="rounded-3xl p-4 sm:p-6 md:p-8 shadow-md bg-[#313030] flex flex-col justify-center items-center">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base md:text-lg text-card-foreground space-y-2 text-center">
              <li>
                ...
                JavaScript, React, React Router), Back-End (Node.js, Express,
                MongoDB)
              </li>
              <li>
              ...
              <li>
                <strong>Approche :</strong> Interface claire et intuitive,
                rigueur technique et lisibilité du code
              </li>
            </ul>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-primary font-semibold leading-relaxed text-center">
            Mon objectif est d'intégrer une équipe innovante où je pourrai
            continuer à développer mes compétences en Front-End et Back-End, et
            contribuer à des projets web performants et accessibles.
          </p>
        </div>
      </div>
    </section>
